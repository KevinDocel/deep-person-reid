...
class MultiGranularityNet(nn.Module):
    """
    Reference:
        Wang et al. Learning Discriminative Features with Multiple Granularities
        for Person Re-Identification. ACM MM, 2018

    Codes are adapted from `https://github.com/GNAYUOHZ/ReID-MGN`
    """

    def __init__(self, num_classes, loss='softmax', pool='max', feats=256, pretrained=True, **kwargs):
